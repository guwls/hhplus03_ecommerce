...
PRODUCT ||--o{CART : "1:N"
    ...
    ORDER {
        ...
        BIGINT  userId          FK  "사용자 고유 id"
        BIGINT  productDetailId FK  "상품상세 id"
        INT     qty                 "주문수량"    
        DECIMAL price               "주문금액"
    ...
    PAYMENT {
        ...
        BIGINT      orderId     FK  "주문 고유 id"
        BIGINT      userId      FK  "사용자 고유 id"
        DECIMAL     price           "결제금액"
        INT         qty             "결제수량"
        INT         status          "결제상태(1:결제완료, 2:결제취소)"
        TIMESTAMP   createAt        "생성일자"
        TIMESTAMP   updateAt        "업데이트일자"
    }
    ...
    CART {
        BIGINT      id          PK  "장바구니id"
        BIGINT      userid      FK  "사용자 id"
        BIGINT      productId   FK  "상품상세 id"
        INT         qty             "상품수량"
        TIMESTAMP   createAt        "생성일자"
        TIMESTAMP   updateAt        "업데이트일자"
    }
